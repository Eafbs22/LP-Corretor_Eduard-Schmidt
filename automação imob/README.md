...
Automação de conteúdo para corretores autônomos e imobiliárias.
...
Com o Claude Code aberto nessa pasta, copie e cole esse prompt:
...
- `_contexto/` — perfil do corretor/imobiliária, preferências e foco atual
- `marca/` — guia de identidade visual (sua marca, da imobiliária ou a definir)
- `conteudo/` — carrosséis, roteiros e ideias gerados
- `imoveis/` — fichas e materiais de imóveis
- `clientes/` — histórico e informações de clientes
